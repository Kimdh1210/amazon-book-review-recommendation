...
# 토크나이저와 모델 로드
tokenizer = AutoTokenizer.from_pretrained("nlp\models")
model = AutoModelForSequenceClassification.from_pretrained("nlp\models").to(device)

# CSV 파일
csv_file_path = 'nlp\divided\output_chunk_7.csv'
...
output_csv_path = os.path.join(output_dir, "predicted_results8_ext.csv")

# 짭 resume 기능
checkpoint_index = 399500
checkpoint_path = os.path.join(output_dir, "checkpoint8.txt")
